...
public class DayAndNightControlLight : MonoBehaviour {
	...
	void UpdateLight()
	{
		...
		// // 	//directionalLight.transform.localRotation = Quaternion.Euler (240, 170, 0);
		// // } else if (currentTime == 1) {
		// // 	//directionalLight.transform.localRotation = Quaternion.Euler (180, 170, 0);
		// // } else {
		// // 	directionalLight.transform.localRotation = Quaternion.Euler ((currentTime * 360f) - 90, 170, 0);
		// // }
